...
$pdf->Rect(15,40,180,59);
$query = "SELECT Top 1 Nombres,departamentopersonal,puesto,localidad,coordinador,inicio_prestamo,fin_prestamo
FROM personal P
INNER JOIN herramientas_personal HP ON P.idpersonal = HP.idpersonal
where P.idpersonal = $idpersonal and estado_herramienta = 'Prestada';";
$resultado = sqlsrv_query($conexion,$query);
while ($line = sqlsrv_fetch_array( $resultado, SQLSRV_FETCH_ASSOC)) {
  $pdf->SetX(15);
  $pdf->MultiCell(90,6,"Nombre: ".$line['Nombres']." ".$line['apellidos']);
  $pdf->SetX(15);
  ...
  $fecha_inicio = date_format($line['inicio_prestamo'],"Y/m/d h:i:s a");
  $fecha_fin = date_format($line['fin_prestamo'],"Y/m/d h:i:s a");
  $pdf->MultiCell(90,6,"inicio: ".$fecha_inicio);
  $pdf->SetX(15);
  $pdf->MultiCell(90,6,"Fin: ".$fecha_fin);
  $pdf->SetX(15);
  $pdf->MultiCell(90,6,"Fecha Actual: ".$fecha);
}
$pdf->Ln(6);
$pdf->SetX(15);
$pdf->SetFont('Arial','B',18);
