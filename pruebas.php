...
<html lang="en">
    ...
    <?php  if($_SESSION['perfil'] == "Sistemas"){
  ...
  <div class="dropdown">
    ...
    <div class="col-sm-6">
      <div class="col-sm-4"><label>Buscar Herramienta</label></div>
      <div class="col-sm-4"><input id='buscarH' class="form-control" type="text" name="" value=""></div>
      <div class="col-sm-2"><button class="btn btn-primary btn-sm" onclick="load(1,'0')">Todas la Herramientas</button></div>
    </div>
  </div>
</div>
            ...
            <div class="col-sm-3"></div>
             <div class="collapse navbar-collapse col-sm-4" align="center">
              <ul class="nav navbar-nav">
               ...
               <li class="active"><a href="altaherramienta.php">solicitud de asignacion</a></li>
               <li><a href="asignarherramientas.php">consulta de asignacion</a></li>
               <li><a href="logout.php">Salir</a></li>
              </ul>
            </div>
          </div>
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div align="left" class="modal-body">
                ...
                echo "Team Viewer:".$Team_Viewer."<br>";
