        ...
        $(document).ready(function(){
          ...
          $( "#btnagregar" ).click(function(){
            ...
            if ( $( "input.asignar" ).is( ":checked" ) || $( "input.prestar" ).is( ":checked" ) ||  $( "input.software" ).is( ":checked" ) || $( "input.accesorio" ).is( ":checked" ))
            {
              ...
              //alert("Contador: "+contadorsoft+":"+contsoft);
              //alert("Contador: "+contadoracce+":"+contacce);

              /*var i = 0;
              while ( i < contadorsoft) {
                alert("Software ["+i+"]: "+software[i]);
                i ++;
              }*/

              /*var j = 0;
              while ( j < contadoracce ) {
                alert("Accesorio ["+j+"]: "+accesorio[j]);
                j ++;
              }*/
    ...
    <table class='table table-striped'>
      ...
      <tbody>
        <tr>
          <td>
          <?php
          $s = "SELECT * from herramientas_personal where idpersonal = '$id' and clave like '%Hard%'";
          $c = sqlsrv_query($conexion,$s);
          $line = sqlsrv_fetch_array( $c, SQLSRV_FETCH_ASSOC);
          $equipo =  $line['estado_herramienta'];
          if($equipo != ""){echo "<label>Equipo</label><br>";}
          else{echo "<label><input id='Hard' data-tipo = 'Hard' type='checkbox' value=''>Equipo</label><br>";}
            $sql0 = "SELECT *
