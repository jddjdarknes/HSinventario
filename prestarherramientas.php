...
<html lang="en">
          ...
          $( "#botones" ).on("click","#btnregresar", function(){
            ...
            $( "#herramientaseleccionada" ).on("click","#bguardar",function(){
              ...
              if(hardware == "" && accesorio == "" && software == "" && unidadredbaja == "" && $borrartodounidadred == ""){
                ...
                $inicio = $( "#inicio" ).val();
                $termino = $("#termino").val();
                //alert("Inicio: "+$inicio+" Termino: "+$termino);
   ...
   <div class="navbar">
     <div class="col-sm-2"></div>
      <div class="collapse navbar-collapse col-sm-4" align="center">
       <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="prestarherramientas.php"><i class="fa fa-pencil-square" style="font-size:24px"></i><br>prestar herramientas</a></li>
    ...
    <div class="col-sm-2">
      <div class="panel panel-default" id="busquedapor">
       ...
       <div id="herramientaseleccionada" class="panel panel-default">
         ...
         <div id="shardware" class="panel panel-default">< Computo ></div>
         <div id="saccesorio" class="panel panel-default">< Accesorio ></div>
    ...
    <div id="mostrarherramientas" class="col-sm-6 panel panel-default" hidden>
     ...
     <div class="col-sm-4" id="" align="left">
       <h4>Software</h4>
       <input type="checkbox" value="7" id="Software" name="check" /> Servidor Virtual<br/>
    ...
    <footer class="col-sm-12">
      ...
      <?php }elseif($_SESSION['departamento'] == "161 [RECLUTAMINETO]" and $rh !== false){//echo "No es Sistemas.";?>
      <body>
        <!-- Top menu -->
       <div align="left">
         <a href="index.php">
